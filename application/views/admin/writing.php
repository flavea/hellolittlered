...
function delete_writing($id) {
	...
	var id = $id;
	if (check == true) {
		window.location.href = "<?=base_url()?>admin/delete_story/".concat(id);
	}
	else {
		return false;
	}
...
<div class="card-panel white">
	...
	<div class="input-field">
		<label>Title</label>
		<input type="text" name="title"value="<?php echo $post->title ?>" required/></div>
		...
		<div class="input-field">
			<label>Fandom</label>
			<input type="text" name="fandom" value="<?php echo $post->fandom ?>" />
		</div>
		
		<div class="input-field">
			<label>Pairs</label>
			<input type="text" name="pairs" value="<?php echo $post->pairs ?>" />
		</div>
		
		<div class="input-field">
			<label>Summary</label>
			<input type="text" name="summary" value="<?php echo $post->summary ?>" />
		</div>
		
		<div class="input-field">
			<label>Link 1</label>
			<input type="url" name="link1" value="<?php echo $post->read1 ?>" />
		</div>
		
		<div class="input-field">
			<label>Link 2</label>
			<input type="url" name="link2" value="<?php echo $post->read2 ?>" />
		</div>
		
		<div class="input-field">
			<label>Link 3</label>
			<input type="url" name="link3" value="<?php echo $post->read3 ?>" />
		</div>
	...
	<div class="input-field">
		...
		<input type="text" name="language" value="<?php echo $post->language ?>" />
	</div>
					...
					<div class="card-panel white">
						...
						<table class="highlight striped">
							...
							<tr>
								...
								echo '<td>
								<a class="waves-effect waves-light btn red darken-4" href="'.base_url().'admin/writing/'.$category->id.'">update</a>
