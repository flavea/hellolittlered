...
<script>
  $(document).ready(function() {
    ...
    <?php if(validation_errors()){ ?>
      Materialize.toast('<?= validation_errors(); ?>', 4000);
    <?php } ?>
    <?php if($this->session->flashdata('message')){ ?>
      Materialize.toast('<?= $this->session->flashdata('message'); ?>', 4000);
    <?php } ?>
  });
</script>
<body>
  ...
  <ul id="nav-mobile" class="side-nav fixed grey darken-3">
    <li><div class="userView">
      ...
      <a class="dropdown-button waves-effect waves-light white-text profile-btn" href="#" data-activates="profile-dropdown"><span class="white-text name"><?= $user->first_name ?><?= $user->last_name ?><i class="material-icons right">arrow_drop_down</i></span></a>
    ...
    <ul class="collapsible" data-collapsible="accordion">
      <li>
        ...
        <div class="collapsible-body">
          <ul class="submenu">
            <li><a href="<?=base_url('blog/add_new_entry');?>">Add New Post</a></li>
            <li><a href="<?=base_url('blog/manage_posts');?>">Manage Posts</a></li>
            <li><a href="<?=base_url('blog/add_new_category');?>">Manage Categories</a></li>
          </ul>
        </div>
      </li>
      <li>
        ...
        <div class="collapsible-body">
          <ul class="submenu">
            <li><a href="<?=base_url('pages/add_new_page');?>">Add New Page</a></li>
            <li><a href="<?=base_url('pages/manage_pages');?>">Manage Pages</a></li>
          </ul>
        </div>
      </li>
      <li>
        ...
        <div class="collapsible-body">
          <ul class="sub-collapsible" data-collapsible="accordion">
            ...
            <li><a href="<?=base_url('projects/projects');?>">Projects</a></li>

            <li><a href="<?=base_url('lab/lab');?>">Lab</a></li>
          </ul>
        </div>
      </li>
      <li>
        ...
        <div class="collapsible-body">
          <ul class="sub-collapsible" data-collapsible="accordion">
            <li><a href="<?=base_url('themes/add_new_theme');?>">Add New Theme</a></li>
            <li>
              ...
              <div class="collapsible-body">
                <ul>
                  <?php if( $theme_categories != '' ): foreach($theme_categories as $cat): ?>
                    ...
                    <li><a class="teal-text text-lighten-2" href="<?=base_url('themes/manage_themes/'.$cat->slug);?>"><?= $cat->category_name;?></a></li>
                  <?php endforeach;endif; ?>
                </ul>
              </div>
            </li>
            <li><a href="<?=base_url('themes/add_new_theme_category');?>">Manage Themes Category</a></li>
          </ul>
        </div>
      </li>
      <li>
        ...
        <div class="collapsible-body">
          <ul class="submenu">
            <li><a href="<?=base_url('resource/add_new_resource');?>">Add New Resource</a></li>
            <li><a href="<?=base_url('resource/manage_resources');?>">Manage Resources</a></li>
            <li><a href="<?=base_url('resource/add_new_resource_type');?>">Manage Resources Type</a></li>
          </ul>
        </div>
      </li>
      <li>
        ...
        <ul class="right">
          ...
          <li class="hide-on-med-and-down"><a href="<?=base_url('admin/friends');?>" class="tooltipped" data-position="bottom" data-delay="50" data-tooltip="Friends"><i class="material-icons">contacts</i>
            <?php if($friends_count != 0) { ?>
              <span class="new badge red"><?= $friends_count; ?></span>
            <?php } ?>
          </a></li>
          ...
          <li><a href="<?=base_url();?>admin/commissions" class="tooltipped" data-position="bottom" data-delay="50" data-tooltip="Commissions"><i class="material-icons">add_shopping_cart</i>
            <?php if($commissions_count != 0) { ?>
              <span class="new badge red"><?= $commissions_count; ?></span>
            <?php } ?>
          </a></li>
          ...
          <li><a href="<?=base_url('admin/questions');?>" class="tooltipped" data-position="bottom" data-delay="50" data-tooltip="Questions"><i class="material-icons question_answer">question_answer</i>
            <?php if($q_count != 0) { ?>
              <span class="new badge red"><?= $q_count; ?></span>
            <?php } ?>
          </a></li>
          ...
          <li><a href="<?=base_url('admin/contacts');?>" class="tooltipped" data-position="bottom" data-delay="50" data-tooltip="Emails"><i class="material-icons mail_outline">mail_outline</i>
            <?php if($emails_count != 0) { ?>
              <span class="new badge red"><?= $emails_count; ?></span>
            <?php } ?>
          </a></li>
