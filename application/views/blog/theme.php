<div id="bg" class="content-real">
	<div id="blog">
			...
			<center>
				<p>
					<img src="<?php echo $post->theme_image; ?>" class="image">
				</p>
				</center>
			<center>
            ...
            <p><b>Type:</b> <?php $item = $this->themes_model->get_related_categories($post->theme_id); foreach($item as $category): ?><a href="<?php echo base_url().$category->slug;?>"><?php echo $category->category_name;?></a> <?php endforeach;?>
