<div id="bg" class="content-real">
	<div id="blog">
			...
			<?php foreach($themes_res as $post):?>
				<li><a href="<?= base_url().'theme/'.$post->theme_id;?>"><?= $post->theme_name?></a></li>
			<?php endforeach; ?>
			</ul></p>
			<?php endif;?>
			...
			<?php foreach($page_res as $post):?>
				<li><a href="<?= base_url().'theme/'.$post->page_id;?>"><?= $post->page_title?></a></li>
			<?php endforeach; ?>
			</ul></p>
			<?php endif;?>
			...
			<?php foreach($writings_res as $post):?>
				<li><a href="<?= base_url().'theme/'.$post->id;?>"><?= $post->title?></a></li>
			<?php endforeach; ?>
			</ul></p>
			<?php endif;?>
			...
			<?php foreach($projects_res as $post):?>
				<li><a href="<?= base_url().'theme/'.$post->id;?>"><?= $post->name?></a></li>
			<?php endforeach; ?>
			</ul></p>
			<?php endif;?>
			</article>
